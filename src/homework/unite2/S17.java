...
// The formula cannot be used for wind speeds below 2 mph or temperatures below -58 oF or above 41oF.
//Write a program that prompts the user to enter a temperature between -58 oF and 41oF and a wind speed greater than or equal to 2
// and displays the wind-chill temperature. Use Math.pow(a, b) to compute v0.16.
