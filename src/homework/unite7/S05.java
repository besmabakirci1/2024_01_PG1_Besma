...
// Write a program that reads in ten numbers and displays the number of distinct numbers and the distinct numbers separated
// by exactly one space (i.e., if a number appears multiple times, it is displayed only once).
